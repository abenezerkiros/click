...
export const CaseStudies2 = () => {
  const caseStudies = [
    ...
    },
    {
      ...
      meta: "influencer",
      title: "Unlocking the Power of Paid Ads And Influencer Marketing",
      link: "service-details",
    },
    {
      image: "assets/images/blog/case-study3.jpg",
      meta: "influencer",
      title: "Client Dominated Market with Influencer Marketing",
      link: "service-details",
    },
  ];
            ...
            >
              <div className="blog-item style-two">
                ...
                <div className="content">
                  ...
                  <div href={study.link} className="read-more">
