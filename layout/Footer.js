      ...
      >
        <div className="row justify-content-between">
          ...
          <div
            ...
            data-aos-offset={50}
          >
            <div className="footer-widget footer-divs">
              <div className="footer-title">
                <h6>Features</h6>
              </div>
              <ul>
                <li>
                  <div href="service-details">Page builder</div>
                </li>
                <li>
                  <div href="service-details">Theme options</div>
                </li>
                <li>
                  <div href="service-details">Modern builder</div>
                </li>
                <li>
                  <div href="service-details">Template library</div>
                </li>
                <li>
                  <div href="service-details">Support Team</div>
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            <div className="footer-widget footer-divs">
              ...
              <ul>
                ...
                <li>
                  <div href="contact">Careers</div>
                </li>
                <li>
                  <div href="blog">News</div>
                </li>
                <li>
                  <div href="about">Media Kit</div>
                </li>
                <li>
          ...
          >
            <div className="footer-widget footer-divs">
              ...
              <ul>
                <li>
                  <div href="about">Overview</div>
                </li>
                <li>
                  <div href="services-two">Features</div>
                </li>
                <li>
                  <div href="services">Solutions</div>
                </li>
                <li>
                  <div href="about">Tutorials</div>
                </li>
                <li>
                  <div href="pricing">Pricing</div>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="copyright-text text-center text-lg-start">
                <p>
                  Copyright © <div href="/">Ridda</div>, all rights reserved.
                </p>
              </div>
            </div>
            <div className="col-lg-7 text-center text-lg-end">
              <ul className="footer-bottom-nav">
                <li>
                  <div href="about">Refund</div>
                </li>
                <li>
                  <div href="about">Privacy Policy</div>
                </li>
                <li>
          ...
          <div className="col-xl-5 col-lg-6">
            ...
            >
              <div className="section-title mb-30">
                <h2>Ready To Connect With A World Class Influencer?</h2>
                <p>
